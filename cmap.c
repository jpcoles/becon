...
void cmap_tipsy(double v, int *r, int *g, int *b)
{
    ...
    if      ( v < 1 ) { *r=0;           *b=0;               *g=255*v;       }
    else if ( v < 2 ) { *r=255*(v-1.0); *b=0;               *g=255;         }
    else if ( v < 3 ) { *r=255;         *b=0;               *g=255*(3.0-v); }
    else if ( v < 5 ) { *r=255;         *b=255*(v-3.0)*0.5; *g=0;           }
    else if ( v < 6 ) { *r=255;         *b=255;             *g=255*(v-5.0); }
